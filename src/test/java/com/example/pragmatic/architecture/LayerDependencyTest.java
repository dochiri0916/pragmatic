...
class LayerDependencyTest {
    ...
    void 레이어_의존성_규칙을_준수해야_한다() {
        Architectures.layeredArchitecture()
                ...
                .layer("Presentation").definedBy("com.example.pragmatic.presentation..")
                .layer("Application").definedBy("com.example.pragmatic.application..")
                .layer("Domain").definedBy("com.example.pragmatic.domain..")
                .layer("Infrastructure").definedBy("com.example.pragmatic.infrastructure..")
                ...
                .ignoreDependency(com.example.pragmatic.PragmaticApplication.class, Object.class)
